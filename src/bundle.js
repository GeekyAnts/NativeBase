...
var updateComponentThemeMap = function (name, inputProps, config, runTimeResolution, props) {
    var _a, _b, _c;
    if (config === void 0) { config = { platform: 'web', colorMode: 'light' }; }
    if (runTimeResolution === void 0) { runTimeResolution = false; }
    var platform = config.platform, colorMode = config.colorMode;
    var componentTheme = get__default["default"](theme, "components.".concat(name), {});
    // let themeObj = {};
    if (runTimeResolution) {
        var themeObj = getThemeObject(name, config.colorMode);
        if (isEmptyObj(themeObj)) {
        ...
        //   platform,
        // });
        var currentColorScheme = (props === null || props === void 0 ? void 0 : props.colorScheme) || ((_a = componentTheme === null || componentTheme === void 0 ? void 0 : componentTheme.defaultProps) === null || _a === void 0 ? void 0 : _a.colorScheme);
        var currentVariant = (props === null || props === void 0 ? void 0 : props.variant) || ((_b = componentTheme === null || componentTheme === void 0 ? void 0 : componentTheme.defaultProps) === null || _b === void 0 ? void 0 : _b.variant);
        var currentSize = (props === null || props === void 0 ? void 0 : props.size) || ((_c = componentTheme === null || componentTheme === void 0 ? void 0 : componentTheme.defaultProps) === null || _c === void 0 ? void 0 : _c.size);
        ...
        if (COLOR_SCHEME_MAP[name]) {
            ...
            //   }
            // );
            if (componentTheme === null || componentTheme === void 0 ? void 0 : componentTheme.variants) {
        ...
        if (componentTheme === null || componentTheme === void 0 ? void 0 : componentTheme.sizes) {
