...
var sizes$l = __assign(
  __assign(__assign({}, spacing), {
    '3xs': 224,
    '2xs': 256,
    'xs': 320,
    'sm': 384,
...
var theme$1 = __assign(
  ...
  { sizes: sizes$l, space: spacing, shadows: shadow, opacity: opacity }
);
...
function findLastValidBreakpoint(values, themeBreakpoints, currentBreakpoint) {
  ...
  var valArray = Array.isArray(values)
    ? values
    : Object.keys(themeBreakpoints).map(function (bPoint) {
        return values[bPoint];
      });
  return (_a = valArray[currentBreakpoint]) !== null && _a !== void 0
    ? _a
    : valArray
...
function baseStyle$y(props) {
  ...
  return {
    color: mode(
      ''.concat(colorScheme, '.600'),
      ''.concat(colorScheme, '.500')
    )(props),
    trackColor: mode(
      ''.concat(colorScheme, '.200'),
      ''.concat(colorScheme, '.800')
    )(props),
  };
}
    ...
    _light: {
      _focus: {
        _stack: {
          style: {
            outlineWidth: '0',
            boxShadow: '0 1px 0 0 '.concat(
              props.focusOutlineColor || primary[600]
            ),
          },
        },
      },
      _invalid: {
        _stack: {
          style: {
            outlineWidth: 0,
            boxShadow: '0 1px 0 0 '.concat(
              props.invalidOutlineColor || error[600]
            ),
          },
        },
      },
      ...
      _focus: {
        _stack: {
          style: {
            outlineWidth: '0',
            boxShadow: '0 1px 0 0 '.concat(
              props.focusOutlineColor || primary[500]
            ),
          },
        },
      },
      _invalid: {
        _stack: {
          style: {
            outlineWidth: 0,
            boxShadow: '0 1px 0 0 '.concat(
              props.focusOutlineColor || error[500]
            ),
          },
        },
      },
...
MARGIN_MAP.margin = __spreadArray(
  __spreadArray([], MARGIN_MAP.mx, true),
  MARGIN_MAP.my,
  true
);
...
PADDING_MAP.padding = __spreadArray(
  __spreadArray([], PADDING_MAP.px, true),
  PADDING_MAP.py,
  true
);
...
var SPREAD_PROP_SPECIFICITY_MAP = __assign(
  __assign({}, PADDING_MAP),
  MARGIN_MAP
);
...
var simplifyProps = function (_a, flattenProps, specificityMap, priority) {
  ...
  var mergePsuedoProps = function (property, propertySpecity) {
    if (compareSpecificity(specificityMap[property], propertySpecity, false)) {
      ...
      flattenProps[property] = merge__default['default'](
        {},
  ...
  for (var property in props) {
    ...
    var propertySpecity = currentSpecificity
      ? __assign({}, currentSpecificity)
      : __assign(
          __assign({}, INITIAL_PROP_SPECIFICITY),
          ((_b = {}), (_b[SPECIFICITY_20] = priority), _b)
        );
    if (
      // @ts-ignore
      state[
        (_c = pseudoPropsMap[property]) === null || _c === void 0
          ? void 0
          : _c.respondTo
      ] ||
...
var propsFlattener = function (_a, priority) {
  ...
  for (var property in props) {
    if (
      // @ts-ignore
      state[
        (_b = pseudoPropsMap[property]) === null || _b === void 0
          ? void 0
          : _b.respondTo
      ] === undefined &&
...
var callPropsFlattener = function (
  targetProps,
  latestSpecifictyMap,
  specificity,
  cleanIncomingProps,
  ...
  return propsFlattener(
    {
      props:
        process.env.NODE_ENV === 'development' && cleanIncomingProps.debug
          ? __assign(__assign({}, targetProps), { debug: true })
          : targetProps,
      //TODO: build-time
      platform: 'web',
      ...
      cascadePseudoProps:
        config === null || config === void 0
          ? void 0
          : config.cascadePseudoProps,
      name: config === null || config === void 0 ? void 0 : config.name,
    },
    specificity
  );
};
var resolvePropsToStyle = function (
  styledSystemProps,
  propStyle,
  theme,
  debug,
...
var resolveValueWithBreakpoint = function (
  values,
  breakpointTheme,
  currentBreakpoint,
  property
...
var propConfig = __assign(
  __assign(
    __assign(
      __assign(
        __assign(
          __assign(
            __assign(__assign(__assign({}, color), space), layout),
            flexbox
          ),
          border
        ),
...
var getRNKeyAndStyleValue = function (_a) {
  ...
  if (config === true) {
    style = __assign(
      __assign({}, style),
      ((_b = {}), (_b[key] = convertStringNumberToNumber(key, value)), _b)
    );
  } else if (config) {
    //@ts-ignore
    ...
    if (typeof val_1 === 'string') {
      if (val_1.endsWith('px')) {
      ...
      } else if (val_1.endsWith('em') && 'web' !== 'web') {
        var fontSize = resolveValueWithBreakpoint(
          styledSystemProps.fontSize,
          theme.breakpoints,
          currentBreakpoint,
          key
        ...
        val_1 =
          parseFloat(val_1) *
          parseFloat(
            get__default['default'](theme.fontSizes, fontSize, fontSize)
          );
      }
    }
    ...
    if (properties) {
      ...
      properties.forEach(function (property) {
        ...
        style = __assign(
          __assign({}, style),
          ((_a = {}), (_a[property] = val_1), _a)
        );
      });
    } else if (property) {
      style = __assign(
        __assign({}, style),
        ((_c = {}), (_c[property] = val_1), _c)
      );
    } else {
...
var getStyleAndFilteredProps = function (_a) {
  ...
  var orderedBreakPoints = Object.entries(theme.breakpoints).sort(function (
    a,
    b
  ) {
    return a[1] - b[1];
  ...
  var _loop_1 = function (key) {
    ...
    if (hasValidBreakpointFormat(rawValue, theme.breakpoints)) {
      ...
      if (
        key === 'size' ||
        (((_b =
          styledSystemProps === null || styledSystemProps === void 0
            ? void 0
            : styledSystemProps.extraProp) === null || _b === void 0
          ? void 0
          : _b.endsWith('.Icon')) &&
          key === 'color')
      ) {
        restDefaultProps = __assign(
          __assign({}, restDefaultProps),
          ((_d = {}), (_d[key] = value), _d)
        );
      } else {
        var newStyle = getRNKeyAndStyleValue({
  ...
  if (responsiveStyles) {
    if (getResponsiveStyles) {
        ...
        if (key === 'base') {
          ...
          if (responsiveStyles)
            if (key in responsiveStyles) {
              (_a =
                query_1 === null || query_1 === void 0
                  ? void 0
                  : query_1.query) === null || _a === void 0
                ? void 0
                : _a.push({
                    minWidth: o[1],
      ...
      //TODO: build-time
      styleFromProps = __assign({}, styleFromProps);
    }
  }
...
var init = function (inputResolvedStyledMap) {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    //@ts-ignore
    window['resolvedStyledMap1'] = exports.resolvedStyledMap;
  }
};
...
var getThemeObject = function (componentName, colorMode, state) {
  ...
  var unResolvedProps = {};
  for (
    var _i = 0, unResolvedPropsArray_1 = unResolvedPropsArray;
    _i < unResolvedPropsArray_1.length;
    _i++
  ) {
  ...
  var restDefaultProps = {};
  for (
    var _a = 0, restDefaultPropsArray_1 = restDefaultPropsArray;
    _a < restDefaultPropsArray_1.length;
    _a++
  ) {
  ...
  var styleFromProps = {};
  for (
    var _b = 0, styleFromPropsArray_1 = styleFromPropsArray;
    _b < styleFromPropsArray_1.length;
    _b++
  ) {
  ...
  for (
    var _c = 0, internalPseudoPropsArray_1 = internalPseudoPropsArray;
    _c < internalPseudoPropsArray_1.length;
    _c++
  ) {
...
var getComponentNameKeyFromProps = function (componentName, _a) {
  ...
  var _c = _a === void 0 ? {} : _a,
    variant = _c.variant,
    colorScheme = _c.colorScheme;
  var componentKeyName = componentName;
  var componentTheme = lodash.get(
    theme,
    'components.'.concat(componentName),
    {}
  );
  var colorSchemeKey =
    colorScheme ||
    ((_b = componentTheme.defaultProps) === null || _b === void 0
      ? void 0
      : _b.colorScheme);
  if (colorSchemeKey && variant) {
    componentKeyName = ''
      .concat(componentName, '.')
      .concat(colorSchemeKey, '.')
      .concat(variant);
  } else if (variant) {
...
var getThemeProps = function (inputComponentKeyName, colorMode, state, props) {
  //
  if (props === void 0) {
    props = {};
  }
  ...
  if (pseudoComponentKeyName) {
    componentKeyName = ''
      .concat(componentKeyName, '.')
      .concat(pseudoComponentKeyName);
  }
  var themeObj = getThemeObject(componentKeyName, colorMode, state);
  ...
  // debugger;
  if (props.size) {
    var componentKeyNameForSize = ''
      .concat(rootComponentName, '.')
      .concat(props.size);
    if (pseudoComponentKeyName) {
      componentKeyNameForSize = ''
        .concat(componentKeyNameForSize, '.')
        .concat(pseudoComponentKeyName);
    }
    var sizeThemeObj = getThemeObject(
      ''.concat(componentKeyNameForSize),
      colorMode,
      state
    );
    ...
    var mergedThemeObj = {
      style: (
        sizeThemeObj === null || sizeThemeObj === void 0
          ? void 0
          : sizeThemeObj.style
      )
        ? __spreadArray(
...
var getResolvedStyleSheet = function (componentName, colorMode, state, props) {
  var _a;
  return (_a = getThemeProps(componentName, colorMode, state, props)) ===
    null || _a === void 0
    ? void 0
    : _a.style;
};
...
var set = function (key, value, colorMode) {
  ...
  if (!styledMap) {
    exports.resolvedStyledMap[key] = ((_a = {}), (_a[colorMode] = [value]), _a);
  } else {
...
var getStyledObject = function (
  ...
  var componentStyle =
    (_b =
      componentTheme === null || componentTheme === void 0
        ? void 0
        : componentTheme.defaultProps) === null || _b === void 0
      ? void 0
      : _b.style;
  var inputWithDefaultProps = __assign(
    __assign({}, componentTheme.defaultProps),
    inputProps
  );
  ...
  var styleObj = resolvePropsToStyle(
    flattenProps,
    componentStyle,
    theme,
    false,
  ...
  try {
    if (themeType[1]) {
      return typeof providedTheme[themeType[0]][themeType[1]] !== 'function'
        ? providedTheme[themeType[0]][themeType[1]]
        : providedTheme[themeType[0]][themeType[1]](
            __assign(__assign({ theme: theme }, incomingProps), {
              colorMode: 'light',
            })
          );
    } else {
...
var mergeStylesWithSpecificity = function (
  componentTheme,
  flattenProps,
  specificityMap,
  colorMode,
  ...
  extendedTheme.map(function (extededComponentTheme) {
    if (extededComponentTheme.baseStyle && mergeDefaultProps) {
      combinedBaseStyle = __assign(
        __assign({}, combinedBaseStyle),
    ...
    if (flattenProps.variant && mergeDefaultProps) {
      if (extededComponentTheme.variants) {
        combinedVariantStyle = __assign(
          __assign({}, combinedVariantStyle),
          resolveComponentTheme(
            flattenProps,
    ...
    if (
      flattenProps.size &&
      (extededComponentTheme === null || extededComponentTheme === void 0
        ? void 0
      ...
      if (
        ...
        combinedSizeStyle = __assign(
          __assign({}, combinedSizeStyle),
          resolveComponentTheme(
            flattenProps,
  ...
  if (!isEmptyObj(combinedBaseStyle)) {
    (_a = callPropsFlattener(
      ...
      (flattenBaseStyle = _a[0]),
      (baseSpecificityMap = _a[1]);
  }
  ...
  if (!isEmptyObj(combinedVariantStyle)) {
    (_b = callPropsFlattener(
      ...
      (flattenVariantStyle = _b[0]),
      (variantSpecificityMap = _b[1]);
  ...
  if (!isEmptyObj(combinedSizeStyle)) {
    (_c = callPropsFlattener(
      ...
      (flattenSizeStyle = _c[0]),
      (sizeSpecificityMap = _c[1]);
  }
  //////
  var defaultStyles = merge__default['default'](
    {},
    flattenBaseStyle,
    flattenVariantStyle,
    flattenSizeStyle
  );
  var defaultSpecificity = merge__default['default'](
    {},
    specificityMap,
    baseSpecificityMap,
  ...
  flattenProps = propsSpreader(
    merge__default['default'](defaultStyles, flattenProps),
    defaultSpecificity
  );
...
//   }
// };
var resolveForInternalPseudoProps = function (
  name,
  key,
  styledObj,
  colorMode,
  ...
  for (var property in styledObj.internalPseudoProps) {
    if (PSEUDO_PROP_COMPONENT_MAP[property]) {
      ...
      updateComponentThemeMapForColorMode(
        PSEUDO_PROP_COMPONENT_MAP[property],
        ''.concat(key, '.').concat(PSEUDO_PROP_COMPONENT_MAP[property]),
      ...
      //   );
      // }
      var styledObjNestedProp = getStyledObject(
        name,
        {},
        colorMode,
        styledObj.internalPseudoProps[property]
        ...
        if (pseudoPropStateMap[property]) {
          ...
          if (componentObj[stateKey]) {
            ...
            componentObj[stateKey] =
              ((_a = {}), (_a[colorMode] = [styledObjNestedProp]), _a);
          }
        } else {
          // console.log(
          //   'hello here &&&*',
          //   styledObj.internalPseudoProps[property]
          // );
          componentObj[colorMode][0].unResolvedProps = __assign(
            __assign({}, componentObj[colorMode][0].unResolvedProps),
            ((_b = {}),
            (_b[property] = styledObj.internalPseudoProps[property]),
            _b)
          );
        }
      }
...
var updateComponentThemeMapForColorMode = function (
  name,
  key,
  inputProps,
  colorMode,
  ...
  var componentTheme = get__default['default'](
    theme,
  ...
  var styledObj = getStyledObject(
    name,
    componentTheme,
    colorMode,
    __assign(__assign({}, inputProps), { extraProp: key }),
    mergeDefaultProps
  );
  set(key, styledObj, colorMode);
...
var updateComponentThemeMap = function (name, inputProps) {
    ...
    for (var color in theme.colors) {
      if (
        ...
        for (var variant in componentTheme.variants) {
          updateComponentThemeMapForColorMode(
            name,
            ''.concat(name, '.').concat(color, '.').concat(variant),
...
exports.getResolvedStyleSheet = getResolvedStyleSheet;
