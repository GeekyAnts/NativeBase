...
var mergeStylesWithSpecificity = function (
  ...
  if (!isEmptyObj(combinedBaseStyle)) {
    (_a = callPropsFlattener(
      ...
      {},
      flattenProps,
      __assign(__assign({}, config), { cascadePseudoProps: true })
    )),
        ...
        if (pseudoPropStateMap[property]) {
          ...
          if (componentObj[stateKey]) {
            ...
            componentObj[stateKey] =
              ((_a = {}), (_a[config.colorMode] = [styledObjNestedProp]), _a);
          }
        } else {
          // console.log(
          //   'hello here &&&*',
          //   styledObj.internalPseudoProps[property]
          // );
          componentObj[config.colorMode][0].unResolvedProps = __assign(
            __assign({}, componentObj[config.colorMode][0].unResolvedProps),
            ((_b = {}),
