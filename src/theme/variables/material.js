...
export default {
  ...
  // Button
  btnFontFamily: (platform === 'ios') ? 'Roboto_medium' : 'sans-serif-medium',
  ...
  // Font
  fontFamily: (platform === 'ios') ? 'Roboto' : 'sans-serif',
  fontSizeBase: 14,
  ...
  // Title
  titleFontfamily: (platform === 'ios') ? 'Roboto_medium' : 'sans-serif-medium',
  titleFontSize: 19,
  subTitleFontSize: 14,
  subtitleColor: '#FFF',
