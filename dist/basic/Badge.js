...
Badge=function(_Component){_inherits(Badge,_Component);function Badge(){_classCallCheck(this,Badge);return _possibleConstructorReturn(this,(Badge.__proto__||Object.getPrototypeOf(Badge)).apply(this,arguments));}_createClass(Badge,[{key:'renderChildren',value:function renderChildren()
...
var newChildren=[];
newChildren.push(_react2.default.createElement(_reactNative.Text,{key:'label',style:[{paddingHorizontal:3,color:_variables.variables.badgeColor,fontSize:_variables.variables.fontSizeBase,lineHeight:_variables.variables.lineHeight-1},this.props.textStyle]},this.props.children));
return newChildren;
}
