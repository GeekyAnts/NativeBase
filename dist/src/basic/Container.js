...
this.props.children,
_react2.default.createElement(_ToastContainer.ToastContainer,{ref:function ref(c){if(!_ToastContainer.ToastContainer.toastInstance)_ToastContainer.ToastContainer.toastInstance=c;}}),
_react2.default.createElement(_Actionsheet.ActionSheetContainer,{ref:function ref(c){if(!_Actionsheet.ActionSheetContainer.actionsheetInstance)_Actionsheet.ActionSheetContainer.actionsheetInstance=c;}})));
