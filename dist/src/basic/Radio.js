...
this.props.selected&&_react2.default.createElement(_IconNB.IconNB,{name:'ios-checkmark',style:{height:20,lineHeight:25,fontSize:30,color:_platform2.default.brandPrimary}}):

_react2.default.createElement(_IconNB.IconNB,{name:this.props.selected?'md-radio-button-on':'md-radio-button-off',style:{fontSize:22,lineHeight:23,color:this.props.selected?_platform2.default.radioSelectedColorAndroid:undefined}})));



}}]);return Radio;}(_react.Component);
