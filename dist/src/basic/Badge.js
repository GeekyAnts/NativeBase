...
var newChildren=[];
newChildren.push(_react2.default.createElement(_reactNative.Text,{key:'label',style:[{paddingHorizontal:3,color:_variables2.default.badgeColor,fontSize:_variables2.default.fontSizeBase,lineHeight:_variables2.default.lineHeight-1},this.props.textStyle]},this.props.children));
return newChildren;
}
