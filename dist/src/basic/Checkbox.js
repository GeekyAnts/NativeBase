...
return(
_react2.default.createElement(_reactNative.TouchableOpacity,_extends({accessible:true,ref:function ref(c){return _this2._root=c;}},this.prepareRootProps(variables),{__source:{fileName:_jsxFileName,lineNumber:40}}),
