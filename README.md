...
4. [Getting started](#4-getting-started)2
...
_Install NativeBase_

```js
npm install native-base --save
```

_Install Peer Dependencies_<br />
...
| v2.3.0 to 2.6.1         | v0.46.0 and above _(does not support React 16.0.0-alpha.13)_ |
