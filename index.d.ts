...
declare module 'native-base' {
    namespace NativeBase {
        ...
        interface ReactListViewProperties extends ReactNative.ScrollViewProperties, React.Props<ReactNative.ListViewStatic> {
             ...
             */
            onChangeVisibleRows?: (visibleRows: Array<{ [sectionId: string]: { [rowID: string]: boolean } }>,
                                   changedRows: Array<{ [sectionId: string]: { [rowID: string]: boolean } }>) => void;
             ...
             */
            renderSeparator?: (sectionID: string | number,
                               rowID: string | number,
